...
export GPGKEY=A1BB4EB11835DE6E
stty icrnl
export GPG_TTY=$(tty)

# The next line updates PATH for the Google Cloud SDK.
if [ -f '/home/ratio/google-cloud-sdk/path.zsh.inc' ]; then . '/home/ratio/google-cloud-sdk/path.zsh.inc'; fi

# The next line enables shell command completion for gcloud.
if [ -f '/home/ratio/google-cloud-sdk/completion.zsh.inc' ]; then . '/home/ratio/google-cloud-sdk/completion.zsh.inc'; fi

# BEGIN SNIPPET: Magento Cloud CLI configuration
HOME=${HOME:-'/home/ratio'}
export PATH="$HOME/"'.magento-cloud/bin':"$PATH":"$HOME/.cargo/bin/"
if [ -f "$HOME/"'.magento-cloud/shell-config.rc' ]; then . "$HOME/"'.magento-cloud/shell-config.rc'; fi # END SNIPPET
export PATH="$HOME/.npm-global/bin:$PATH:$HOME/go/bin/MailHog"


### NodeJS User configuration
